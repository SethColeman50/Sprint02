 ...
 * Stores the nation, tribe, the fact that they are a warrior, life points and the strategy.
 */

public class SchaperWarrior extends People
{
    /**
     * The constructor for SchaperWarrior. Gets passed the nation, tribe, life points and strategy.
     ...
     * specific individual to decide what happens. Returns the number of life points to be added or taken.
