 ...
 * It has the potential to deal a lot of damage, but dies very easily due to how chances there are for it to take a lot of damage too.
 */
public class WeebWizardStart implements Strategy
{
    /**
     ...
     * But casting the spell, which deals damage equal to total health atm, kills them off.
     *
